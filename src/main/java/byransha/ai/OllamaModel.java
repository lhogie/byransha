...
public class OllamaModel {
	...
	final private static OllamaChatModel instance = OllamaChatModel.builder().baseUrl("http://localhost:11434")
			...
			.modelName("granite4:tiny-h").temperature(0.2).supportedCapabilities(RESPONSE_FORMAT_JSON_SCHEMA)
	...
	private static String chatWithFallback(String prompt) {
		if (fallbackInstance == null) {
			fallbackInstance = OllamaChatModel.builder().baseUrl("http://localhost:11434").modelName(FALLBACK_MODEL)
