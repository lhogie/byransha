...
public class NumericRangeFilter extends FieldFilterNode {
    public IntNode minValue;
    public IntNode maxValue;
    ...
    public NumericRangeFilter(BBGraph g, User creator) {
        super(g, creator);
        minValue = new IntNode(g, creator);
        maxValue = new IntNode(g, creator);
        includeNull = new BooleanNode(g, creator, true);
        includeMin = new BooleanNode(g, creator, true);
        includeMax = new BooleanNode(g, creator, true);
    }
