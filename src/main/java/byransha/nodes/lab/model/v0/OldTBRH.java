...
class OldTBRH {
    private static void loadOLDTBRH(Lab i3s, User user, File inputDir) throws IOException {
...
//            person.etatCivil.nationality.set(l.set(7, null));
            ...
            for (var campusName : List.of(l.set(10, null), l.set(11, null))) {
                if (!campusName.isBlank()) {
                    var campus = i3s.g.find(Campus.class, n -> {
            ...
            var email = new EmailNode(i3s.g, user);
            email.set(l.set(19, null), user);
            person.emailAddresses.add(email, user);
            person.researchGroup = i3s.g.find(ResearchGroup.class, n -> {
                        if (n.name != null && n.name.get() != null) {
            ...
            for (var i : List.of(25, 26)) {
                ...
                person.position.employer = i3s.g.find(ResearchGroup.class, n -> {
                            if (n.name != null && n.name.get() != null) {
