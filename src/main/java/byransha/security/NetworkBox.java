...
public class NetworkBox {
	 ...
	 *
	 * @param senderPriv
	 *                        The private key of the sender (e.g., Node A).
	 * @param receiverPub
	 *                        The public key of the recipient (e.g., Node D).
	 * @param payload
	 *                        The raw data to encrypt (e.g., CBOR-serialized
	 *                        object).
	 ...
	 *
	 * @param sharedSecret
	 *                         The cached Key derived from agreeOnSharedSecret().
	 * @param payload
	 *                         The data to encrypt.
