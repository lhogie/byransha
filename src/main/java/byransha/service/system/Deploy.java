...
import byransha.service.system.Byransha.byransha;
...
public class Deploy extends Action<Byransha> {
	...
	protected void impl() throws Throwable {
		if (Byransha.lastVersionOnline().equals(hub().byransha.VERSION))
		...
		var n = new ObjectNode(ByUtils.factory);
		n.put("version", hub().byransha.VERSION);
