    ...
    return (
        ...
        >
            <Box sx={{ 
                ...
                <Card className="existing-node-card" sx={{ width: '100%', maxHeight: '80vh', overflow: 'auto' }}>
                    <CardHeader
                    ...
                    <CardContent>
                        ...
                        <Box className="node-list" sx={{ maxHeight: '50vh', overflow: 'auto' }}>
                            {loadingExistingNodes ? (
                                <Box display="flex" justifyContent="center" p={2}>
                                    <CircularProgress size={24} /> <Typography sx={{ ml: 1 }}>Loading nodes...</Typography>
                                </Box>
                            ) : (
                                <Stack spacing={1}>
